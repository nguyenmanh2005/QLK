...
import { Package, Loader2, ChevronDown, Truck } from 'lucide-react'
...
function OrdersContent() {
  ...
  const tabs = [
    ...
    { key: 'Delivering', label: 'Shipper đang giao' },
                ...
                <div className="flex-1">
                  ...
                  {order.shipperName && (
                    <p className="text-sm text-slate-400 mt-1 flex items-center gap-1.5">
                      ...
                      <span>Shipper: </span>
                      <span className="text-indigo-300 font-medium">{order.shipperName}</span>
                    </p>
                  )}
